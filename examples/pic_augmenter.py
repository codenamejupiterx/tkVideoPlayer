#GitHub Repo Source: https://medium.com/predict/data-augmentation-for-custom-object-detection-15674966e0c8
# Importing Libraries
import os
import numpy as np
import cv2
...
if __name__ == "__main__":
    ...
    for filename in tqdm(os.listdir("/Users/benjaminhall/VS_CODE_Python_Folder/augmentation_test1/")):
        file =filename.split(".")
        if(file[-1]=="jpeg"):
            image_name=file[0]
            image_ext="."+file[1]
        ...
        for angle in angels:
            ...
            cv2.imwrite(image_name+'_' + str(angle) + '.jpeg', image)
